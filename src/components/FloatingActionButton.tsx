    ...
    <div className="fixed z-50">
      <Button
        ...
        className={`
          ...
          fixed rounded-full p-0 border-0 
          transition-all duration-300 ease-out
          hover-lift ripple-container
      ...
      >
        ...
        {tooltip && isHovered && (
          <div className="absolute bottom-full right-0 mb-2 px-3 py-1 text-xs glass-intense rounded-lg whitespace-nowrap animate-fade-in">
            {tooltip}
          </div>
        )}
      </Button>
